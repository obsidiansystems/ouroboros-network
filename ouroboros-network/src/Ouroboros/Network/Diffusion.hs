...
data DiffusionArguments = DiffusionArguments {
    ...
    , daProtocolIdleTimeout :: DiffTime
      ...
      -- connections.
      --
      -- See 'cmProtocolIdleTimeout', 'serverRespondersIdleTimeout'.

    , daWaitTimeTimeout :: DiffTime
...
local_PROTOCOL_IDLE_TIMEOUT = 0.25 -- 250 miliseconds

-- | Used to set 'cmWaitTimeout' for local (e.g. /node-to-client/) connections.
--
local_WAIT_TIME_TIMEOUT :: DiffTime
local_WAIT_TIME_TIMEOUT = 0
    ...
    withLocalSocket iocp tracer daLocalAddress $ \localSnocket localSocket -> do
      let localConnectionHandler :: NodeToClientConnectionHandler
          ...
          localConnectionManagerArguments =
            ConnectionManagerArguments {
                ...
                cmWaitTimeTimeout     = local_WAIT_TIME_TIMEOUT,
                cmProtocolIdleTimeout = local_PROTOCOL_IDLE_TIMEOUT
              }
      ...
      withConnectionManager
        ...
        Async.withAsync
          (Server.run
            ServerArguments {
                serverHasInitiator          = SingNoInitiator,
                ...
                serverRespondersIdleTimeout = local_PROTOCOL_IDLE_TIMEOUT
          ...
          let connectionManagerArguments :: NodeToNodeConnectionManagerArguments
              connectionManagerArguments =
                ConnectionManagerArguments {
                    ...
                    cmProtocolIdleTimeout = daProtocolIdleTimeout,
                    cmWaitTimeTimeout     = daWaitTimeTimeout
                  }
                          ...
                          Async.withAsync
                            (Server.run
                              ServerArguments {
                                  ...
                                  serverRespondersIdleTimeout = daProtocolIdleTimeout,
...
nodeCompatMode = \v -> v < NodeToNodeV_6
